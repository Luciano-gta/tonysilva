                ...
                <fieldset>
                    ...
                    <form action="action_cliente.php" method="post" id='form-contato' enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="cod_cart" name="cod_cart" placeholder="Informe o codigo do cartão">
                        ...
                        <div class="row">
                            <div class="col-md-2"> 
                                ...
                                <input type="cep" class="form-control" id="cep" name="cep" maxlength="10" placeholder="Informe o CEP">
                                <!-- para validacao <span class='msg-erro msg-email'></span> -->
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="endereco" name="endereco" placeholder="Informe Rua, Nºcasa/APTO">
                                <!-- para validacao <span class='msg-erro msg-email'></span> -->
                            </div>
                        </div>
